      ...
      <div class="card-body">
        ...
        <div class="collapse" id="collapseExample">
          <div class="d-grid d-sm-flex p-3 border">
            <img src="{{asset('theme/assets/img/elements/1.jpg')}}" alt="collapse-image" height="125" class="me-4 mb-sm-0 mb-2">
            <span>
        ...
        <div class="row">
          <div class="col-12 col-md-6 mb-2 mb-md-0">
            <div class="collapse multi-collapse" id="multiCollapseExample1">
              <div class="d-grid d-sm-flex p-3 border">
                <img src="{{asset('theme/assets/img/elements/2.jpg')}}" alt="collapse-image" height="125" class="me-4 mb-sm-0 mb-2">
                <span>
          ...
          <div class="col-12 col-md-6">
            <div class="collapse multi-collapse" id="multiCollapseExample2">
              <div class="d-grid d-sm-flex p-3 border">
                <img src="{{asset('theme/assets/img/elements/3.jpg')}}" alt="collapse-image" height="125" class="me-4 mb-sm-0 mb-2">
                <span>
